...
static const K32_EXPORT k32_exports[] = {
    ...
    { "GetStringTypeA",          (PVOID)GetStringTypeA,          4, CC_STDCALL },
    ...
    { "PeekNamedPipe",           (PVOID)PeekNamedPipe_stub,      6, CC_STDCALL },
    ...
    { "CreatePipe",              (PVOID)CreatePipe_stub,         4, CC_STDCALL },
    ...
    { "GlobalFree",              (PVOID)GlobalFree_stub,         1, CC_STDCALL },
    ...
    { "GetFileAttributesA",      (PVOID)GetFileAttributesA_k32,  1, CC_STDCALL },
