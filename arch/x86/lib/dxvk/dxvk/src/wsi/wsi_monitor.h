...
/* OsitoK W5.2: drop <windows.h> — HMONITOR/LUID/WCHAR come from
 * dxvk_compat.h which is force-included before this header. RECT
 * isn't a Win32 typedef we need everywhere, so define it here. */
