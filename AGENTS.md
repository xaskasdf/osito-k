...
This project is indexed by GitNexus as **osito-k** (73166 symbols, 89220 relationships, 76 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
